...
WebDriver driver = new ChromeDriver();
	...
	String reqerr=driver.findElement(By.xpath("//span[contains(text(),'The maximum quantity allowed for purchase is 500.')]")).getText();
   ...
   String noItemsMsg = driver.findElement(By.xpath("//body[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[2]/p[1]")).getText();
